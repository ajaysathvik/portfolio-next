...
export default function ButtonCV() {
  return (
    <div className="group relative flex justify-center items-center text-sm font-medium border-gray-50 border w-fit rounded-full">
      ...
      <div className="shadow-md flex items-center group-hover:gap-2 p-3 rounded-full cursor-pointer duration-300 mx-1">
        <PiDownloadSimple  />
